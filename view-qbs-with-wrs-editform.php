...
<button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#editTeamModal<?php echo $qbwr['team_id']; ?>">
...
<!-- Modal -->
<div class="modal fade" id="editTeamModal<?php echo $qbwr['team_id']; ?>" tabindex="-1" aria-labelledby="editTeamModalLabel<?php echo $qbwr['team_id']; ?>" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="editSectionModalLabel<?php echo $qbwr['team_id']; ?>">Edit Quarterback</h1>
