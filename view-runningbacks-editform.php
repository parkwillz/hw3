    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="">
          ...
          <div class="mb-3">
            <label for="rRYOA<?php echo $runningback['runningback_id']; ?>" class="form-label">Runningback RYOA</label>
            <input type="text" class="form-control" id="rRYOA<?php echo $runningback['runningback_id']; ?>" name="rRYOA" value="<?php echo $runningback['runningback_ryoa']; ?>">
          </div>
